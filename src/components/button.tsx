...
const Button: React.FC<ButtonProps> = ({
    ...
    const classes = clsx(
        "px-4 py-2 rounded transition-all duration-fast ease-in-out",
        {
            ...
            "bg-button text-button-text": variant === "tab" && isActive,
            "bg-button text-button-secondary-text": variant === "tab" && !isActive,
        },
        className
    );
